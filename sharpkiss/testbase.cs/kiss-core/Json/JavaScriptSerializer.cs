...
namespace Kiss.Json
{
    public class JavaScriptSerializer
    {
        ...
        public dynamic DeserializeObject(string input)
        {
        ...
        internal void Serialize(object obj, StringBuilder output, SerializationFormat serializationFormat)
        {
            ...
            {
                throw new InvalidOperationException("JSON_MaxJsonLengthExceeded");
            }
        }
        ...
        private static void SerializeDateTime(DateTime datetime, StringBuilder sb, SerializationFormat serializationFormat)
        {
            ...
            {
                sb.Append("\"\\/Date(");
                sb.Append((long)((datetime.Ticks - DatetimeMinTimeTicks) / 0x2710L));
                sb.Append(")\\/\"");
            }
            else
            {
        ...
        private void SerializeValue(object o, StringBuilder sb, int depth, Hashtable objectsInUse, SerializationFormat serializationFormat)
        {
            ...
            {
                throw new ArgumentException("JSON_DepthLimitExceeded");
            }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (enumType.IsEnum)
                        {
                            ...
                            {
                                throw new InvalidOperationException("JSON_InvalidEnumType");
                            }
                        ...
                        else
                        {
                            try
                            {
                                ...
                                {
                                    throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, "JSON_CircularReference", new object[] { enumType.FullName }));
                                }
        ...
        public int RecursionLimit
        {
            ...
            set
            {
                if (value < 1)
                {
                    throw new ArgumentOutOfRangeException("JSON_InvalidRecursionLimit");
                }
